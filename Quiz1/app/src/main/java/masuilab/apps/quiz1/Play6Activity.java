...
public class Play6Activity extends AppCompatActivity {
    ...
    public void onButton17(View v){
        Intent intent = new Intent(Play6Activity.this, Result6Activity.class);
        // counter = 0;
