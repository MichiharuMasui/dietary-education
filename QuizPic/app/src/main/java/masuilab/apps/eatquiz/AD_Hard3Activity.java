...
public class AD_Hard3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad__hard3);
    ...
    public void onButton6(View v){
        Intent intent = new Intent(AD_Hard3Activity.this, AD_Hard3ResultActivity.class);
        // counter = 0;
