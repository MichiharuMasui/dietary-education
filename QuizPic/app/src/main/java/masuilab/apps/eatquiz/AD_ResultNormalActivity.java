...
public class AD_ResultNormalActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ad__result_normal);
    ...
    public void onNext(View v) {
        Intent intent = new Intent(AD_ResultNormalActivity.this, MainActivity.class);
