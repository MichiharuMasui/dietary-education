...
public class AD_Hard1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad__hard1);
    ...
    public void onButton1(View v){
        Intent intent = new Intent(AD_Hard1Activity.this, AD_Hard1ResultActivity.class);
