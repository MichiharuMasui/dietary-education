...
public class AD_Easy2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad__easy2);
    ...
    public void onButton3(View v){
        Intent intent = new Intent(AD_Easy2Activity.this, AD_Easy2ResultActivity.class);
        // counter = 0;
