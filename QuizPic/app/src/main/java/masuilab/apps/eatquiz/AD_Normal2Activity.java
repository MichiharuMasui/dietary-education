...
public class AD_Normal2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad__normal2);
    ...
    public void onButton3(View v){
        Intent intent = new Intent(AD_Normal2Activity.this, AD_Normal2ResultActivity.class);
        // counter = 0;
