...
public class AD_Easy1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad__easy1);
    ...
    public void onButton1(View v){
        Intent intent = new Intent(AD_Easy1Activity.this, AD_Easy1ResultActivity.class);
        rightAnswerCount++;
