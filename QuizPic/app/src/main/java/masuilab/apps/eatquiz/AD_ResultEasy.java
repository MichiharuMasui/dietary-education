...
public class AD_ResultEasy extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ad__result_easy);
    ...
    public void onNext(View v) {
        Intent intent = new Intent(AD_ResultEasy.this, MainActivity.class);
