...
public class AD_Normal3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad__normal3);
    ...
    public void onButton6(View v){
        Intent intent = new Intent(AD_Normal3Activity.this, AD_Normal3ResultActivity.class);
        // counter = 0;
