...
public class Ei_Play2Activity extends AppCompatActivity implements View.OnTouchListener{

    private CustomImageView cImageView_kabo, cImageView_komatsu, cImageView_kome,cImageView_hokki,cImageView_daizu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ei__play2);
        ...
        cImageView_komatsu = findViewById(R.id.image_view_komatsu);
        cImageView_kome = findViewById(R.id.image_view_kome);
        cImageView_hokki= findViewById(R.id.image_view_hokki);
        cImageView_daizu = findViewById(R.id.image_view_daizu);

        //リスナーの設定
        cImageView_kabo.setOnTouchListener(this); // 画像0
        cImageView_komatsu.setOnTouchListener(this); // 画像1
        cImageView_kome.setOnTouchListener(this); // 画像2
        cImageView_hokki.setOnTouchListener(this); // 画像3
        cImageView_daizu.setOnTouchListener(this); // 画像3
    }
    @Override
    ...
    public void onButton(View v) {
        Intent intent = new Intent(Ei_Play2Activity.this, Ei_Play2ResultActivity.class);
        // counter = 0;
        if (
