...
public class Play3Activity extends AppCompatActivity implements View.OnTouchListener{

    private CustomImageView cImageView_endo, cImageView_jaga, cImageView_daikon,cImageView_takenoko,cImageView_tamanegi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cImageView_endo = findViewById(R.id.image_view_endo);
        cImageView_jaga = findViewById(R.id.image_view_jaga);
        cImageView_daikon = findViewById(R.id.image_view_daikon);
        cImageView_takenoko = findViewById(R.id.image_view_takenoko);
        cImageView_tamanegi = findViewById(R.id.image_view_tamanegi);

        //リスナーの設定
        cImageView_endo.setOnTouchListener(this); // 画像0
        cImageView_jaga.setOnTouchListener(this); // 画像1
        cImageView_daikon.setOnTouchListener(this); // 画像2
        cImageView_takenoko.setOnTouchListener(this); // 画像3
        cImageView_tamanegi.setOnTouchListener(this); // 画像3
    }
    ...
    public void onButton(View v) {
        Intent intent = new Intent(Play3Activity.this, Play3ResultActivity.class);
        // counter = 0;
        if ((680 < location[0][1] && location[0][1] < 970)&& (1200 < location[1][1] && location[1][1] < 1470)
                ...
                && (1200 < location[4][1] && location[4][1] < 1470)){
