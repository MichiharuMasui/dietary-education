...
public class Play5Activity extends AppCompatActivity implements View.OnTouchListener{

    private CustomImageView cImageView_haku, cImageView_pi, cImageView_bro,cImageView_hou,cImageView_reta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cImageView_haku = findViewById(R.id.image_view_haku);
        cImageView_pi = findViewById(R.id.image_view_pi);
        cImageView_bro = findViewById(R.id.image_view_bro);
        cImageView_hou = findViewById(R.id.image_view_hou);
        cImageView_reta = findViewById(R.id.image_view_reta);

        //リスナーの設定
        cImageView_haku.setOnTouchListener(this); // 画像0
        cImageView_pi.setOnTouchListener(this); // 画像1
        cImageView_bro.setOnTouchListener(this); // 画像2
        cImageView_hou.setOnTouchListener(this); // 画像3
        cImageView_reta.setOnTouchListener(this); // 画像3
    }
    ...
    public void onButton(View v) {
        Intent intent = new Intent(Play5Activity.this, Play5ResultActivity.class);
        // counter = 0;
        if ((1200 < location[0][1] && location[0][1] < 1470)&& (680 < location[1][1] && location[1][1] < 970)
                && (680 < location[2][1] && location[2][1] < 970) && (680 < location[3][1] && location[3][1] < 970)
