...
public class Ei_Play1Activity extends AppCompatActivity implements View.OnTouchListener{

    private CustomImageView cImageView_aice, cImageView_aspara, cImageView_jaga,cImageView_kaki,cImageView_syako;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ei__play1);
        ...
        cImageView_kaki = findViewById(R.id.image_view_kaki);
        cImageView_syako = findViewById(R.id.image_view_syako);

        //リスナーの設定
        cImageView_aice.setOnTouchListener(this); // 画像0
        cImageView_aspara.setOnTouchListener(this); // 画像1
        cImageView_jaga.setOnTouchListener(this); // 画像2
        cImageView_kaki.setOnTouchListener(this); // 画像3
        cImageView_syako.setOnTouchListener(this); // 画像3
    }
    ...
    public void onButton(View v) {
        Intent intent = new Intent(Ei_Play1Activity.this, Ei_Play1ResultActivity.class);
        // counter = 0;
        if (
